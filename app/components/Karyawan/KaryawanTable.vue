        ...
        <div v-else class="flex flex-col sm:flex-row gap-3 w-full">
            ...
            <div class="w-full sm:w-48">
                ...
                >
                  ...
                  <option value="Mandau Air">Mandau Air</option>
              ...
              <div class="flex items-start justify-between">
                <div class="flex items-center gap-3">
                   ...
                   <div>
                      ...
                      <span class="inline-flex mt-1 items-center px-2 py-0.5 rounded text-xs font-medium bg-green-100 text-green-800 border border-green-200">
                        {{ item.jabatan }}
                      </span>
                   </div>
                </div>
        ...
        <table class="w-full whitespace-nowrap">
          <thead class="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th scope="col" class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Jabatan</th>
          ...
          <tr v-if="isLoading">
            <td colspan="4" class="px-6 py-20 text-center">
              <div class="flex flex-col items-center justify-center">
                ...
                <p class="text-gray-500 text-sm">Memuat data karyawan...</p>
              </div>
            </td>
          </tr>
...
<script setup>
// Script setup tetap sama, tidak ada perubahan logika, hanya perubahan template di atas.
...
// Simulated API Call for Demo (Replace with your actual useApi)
async function fetchData(page = 1) {
    ...
    try {
        ...
        // Ganti baris ini dengan real API Anda
        const response = await useApi(`karyawan?${params.toString()}`)
...
const processDelete = async (idsToDelete) => {
    ...
    try {
        const deletePromises = idsToDelete.map(id => 
             useApi(`karyawan/${id}`, { method: 'DELETE' })
        )
...
const bulkDelete = async () => {
    ...
    if (!confirm(`Yakin ingin menghapus ${selectedIds.value.length} data karyawan terpilih?`)) return

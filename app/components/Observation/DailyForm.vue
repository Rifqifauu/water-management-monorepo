        ...
        <form @submit.prevent="saveData" class="space-y-10">
          ...
          <div class="bg-blue-50 rounded-2xl p-6 border border-blue-100 shadow-inner">
            <div class="grid md:grid-cols-2 gap-4  items-center mb-6">
                ...
                <button type="button" @click="getGeoLocation" class="flex items-center gap-2 text-sm bg-white text-blue-700 px-4 py-2 rounded-xl border border-blue-200 font-bold shadow-sm hover:shadow-md hover:bg-blue-50 transition active:scale-95">
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div>
                 ...
                 <select v-model="form.tipe_objek" class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-medium">
                   <option value="">Pilih Objek</option>
                   <option value="Parit">Parit</option>
                   <option value="Genangan">Genangan</option>
                   <option value="Siltpit/Rorak">Siltpit/Rorak</option>
                 </select>            
              </div>
              <div>
                 <label class="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide">Nomor Jalur</label>
                 <input v-model="form.nomor_jalur" type="text" class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-medium">
              </div>
              <div>
                 <label class="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide">Kedalaman (cm)</label>
                 <input v-model="form.kedalaman_cm" type="number" class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-medium">
              </div>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div>
                 <label class="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide">Jumlah Pokok</label>
                 <input v-model="form.jumlah_pokok" type="number" class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-medium">
              </div>
               <div>
                 <label class="block text-sm font-bold text-gray-700 mb-2 uppercase tracking-wide">Durasi Genangan</label>
                 <select v-model="form.durasi_genangan" class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 font-medium">
                   <option value="">Pilih Durasi</option>
                   <option value="1">1 Hari</option>
                   <option value="2">2 Hari</option>
                   <option value="3">Lebih dari 2 Hari</option>
                 </select>
              </div>
               <div>
...
const saveData = async () => {
    ...
    try {        
        ...
        const response = await useApi('monitoring-harian', {
            method: 'POST',
            body: formData
        })

        ...
        <form @submit.prevent="saveData" class="space-y-10">
          ...
          <div class="bg-white rounded-xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <SearchableSelect v-model="form.id_karyawan" :options="listKaryawan" label-key="nama" value-key="id" placeholder="Cari Nama Observer..." />
              </div>
            </div>
          ...
          <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <input v-model.number="form.tinggi_level_air" type="number" step="0.01" :class="cls.input" placeholder="Masukkan tinggi air...">
              </div>
              <div>
                <div class="flex justify-between items-center mb-2">
                ...
                <input v-model.number="form.jarak_ke_bibir" type="number" step="0.01" :class="cls.input" placeholder="Masukkan jarak ke bibir...">
              </div>
            </div>
          </div>
          ...
          <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200">
             ...
             <div class="mt-6">
                ...
                <textarea v-model="form.keterangan" rows="3" :class="cls.input" placeholder="Catatan tambahan..."></textarea>
            </div>
          </div>
          ...
          <div class="flex flex-col md:flex-row gap-4 pt-4 border-t border-gray-200">
            ...
            <button type="button" @click="$emit('close')" class="px-8 py-4 border-2 border-gray-300 rounded-xl font-bold text-gray-600 hover:bg-gray-100 transition">
              Cancel
            </button>
          </div>
        </form>
...
const form = reactive({
  ...
  lat_aktual: '',
  long_aktual: '',
  no_water_level: 1, // Default set to 1

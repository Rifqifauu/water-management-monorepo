        ...
        children: [
          ...
          const Positioned(
            ...
            child: Opacity(
              opacity: 0.5,
              child: WavyHeader(
                  height: 300, isReverse: true, color: Color(0xFF64B5F6)),
            ),
          ),
          const Positioned(
            top: 0,
...
class WaveClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    var firstControlPoint =
        Offset(size.width / 4, isReverse ? size.height : size.height - 80);
    var firstEndPoint = Offset(size.width / 2, size.height - 40);

    var secondControlPoint = Offset(size.width - (size.width / 4),
        isReverse ? size.height - 80 : size.height);
